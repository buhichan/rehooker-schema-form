...
function FieldArray(props) {
    var add = React.useMemo(function () { return function () {
        props.form.next(mutations_1.addArrayItem(props.schema.key, props.keyPath, props.value));
    }; }, [props.schema, props.value]);
    var remove = React.useMemo(function () { return function (id) {
        props.form.next(mutations_1.removeArrayItem(props.schema.key, props.keyPath, props.value, id));
    }; }, [props.schema, props.value]);
