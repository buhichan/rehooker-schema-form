...
function TextInput(props) {
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(Input, __assign({ type: props.schema.type, id: props.schema.key, className: "full-width", style: { width: "100%" }, name: props.schema.name, value: props.value, onChange: props.onChange }, props.componentProps)));
}
...
function CheckboxInput(props) {
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(Checkbox, __assign({ onChange: function (e) { return props.onChange(e.target.checked); }, checked: Boolean(props.value) }, props.componentProps)));
}
...
function DateTimeInput(props) {
    ...
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(DatePicker, __assign({ showTime: true, format: props.componentProps.dateFormat || DEFAULT_DATETIME_FORMAT, value: value, style: { width: "100%" }, onChange: function (m, dateString) {
...
function DateTimeRangeInput(props) {
    ...
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(RangePicker, __assign({ showTime: { format: 'HH:mm:ss' }, style: { width: "100%" }, format: props.componentProps.dateFormat || DEFAULT_DATETIME_FORMAT, placeholder: ['开始时间', '结束时间'], value: range, onChange: function (m, dataStrings) {
                if (m) {
                    props.componentProps.unixtime ?
...
function NumberInput(props) {
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(InputNumber, __assign({ style: { width: "100%" }, id: props.schema.key, min: 0, value: isNaN(parseFloat(props.value)) ? 0 : parseFloat(props.value), onChange: function (value) {
    ...
    FileInput.prototype.render = function () {
        return React.createElement("div", { style: { paddingLeft: "var(--schema-form-label-width)" } },
            React.createElement("div", null,
                React.createElement(Upload, __assign({ fileList: this.props.value || emptyArray, multiple: true, onChange: this.onChange, customRequest: this.customRequest }, this.props.componentProps),
...
function SelectRadio(props) {
    var options = useEnumOptions(props.schema.options);
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(RadioGroup, __assign({ value: props.value, onChange: function (v) { return props.onChange(v); } }, props.componentProps), options ? options.map(function (option) { return (React.createElement(Radio, { style: {
                width: "auto",
                flex: 1,
                whiteSpace: "nowrap",
                margin: "0 15px 0 0"
...
function DateRangeInput(props) {
    ...
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(RangePicker, __assign({ defaultValue: [from ? moment(from, dateFormat) : undefined, to ? moment(to, dateFormat) : undefined], format: dateFormat, onChange: function (_, dateStrings) { props.onChange(dateStrings); } }, props.componentProps)));
}
function TextareaInput(props) {
    return React.createElement(InputWraper, __assign({}, props),
        React.createElement(TextArea, __assign({ value: props.value, onChange: function (value) { return props.onChange(value); }, autosize: { minRows: 4, maxRows: 8 } }, props.componentProps)));
}
var AutoCompleteAsync = /** @class */ (function (_super) {
    ...
    AutoCompleteAsync.prototype.render = function () {
        ...
        return React.createElement(InputWraper, __assign({}, this.props),
            React.createElement(AutoComplete, __assign({ dataSource: this.state.dataSource, style: { width: "100%" }, onSelect: onChange, onSearch: this.onUpdateInput, filterOption: false }, componentProps)));
    };
...
function GroupRenderer(_a) {
    ...
    return React.createElement(Collapse, __assign({ defaultActiveKey: ["0"], style: { marginBottom: 15 } }, componentProps),
            ...
            return React.createElement(Collapse.Panel, { forceRender: true, showArrow: false, key: String(index), header: React.createElement("div", null,
                    ...
                    React.createElement("div", { className: "delete-button", onClick: function (e) { return e.stopPropagation(); } },
                        React.createElement(Tooltip, { placement: "topLeft", title: "\u5220\u9664", arrowPointAtCenter: true },
                            React.createElement("i", { style: { cursor: "pointer", marginRight: 8 }, onClick: function () {
