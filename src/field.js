...
var StatelessField = React.memo(function StatelessField(props) {
    ...
    switch (schema.type) {
        ...
        case "virtual-group":
            return React.createElement(React.Fragment, null, renderFields(form, schema.children, keyPath));
        case "group":
            return React.createElement("div", { className: className, style: schema.style },
                React.createElement("fieldset", null,
                    React.createElement("legend", null, schema.label),
                    React.createElement("div", { className: "schema-node" }, renderFields(form, schema.children, keyPath + "." + schema.key))));
        default:
...
var StatefulField = React.memo(function StatefulField(props) {
    ...
    React.useEffect(function () {
        ...
        var $change = rxjs_1.merge.apply(void 0, schema.listens.map(function (x) {
