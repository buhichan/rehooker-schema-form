...
var DropDownMenu = (function (_super) {
    ...
    DropDownMenu.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({}, other, { ref: function (node) {
                _this.rootNode = node;
            }, className: className, style: prepareStyles(Object.assign({}, styles.root, open && styles.rootWhenOpen, style)) }),
            React.createElement(ClearFix_1.default, tslib_1.__assign({ style: styles.control }, { onTouchTap: this.handleTouchTapControl }),
